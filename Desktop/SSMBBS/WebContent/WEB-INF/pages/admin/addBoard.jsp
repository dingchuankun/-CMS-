...
<div class="mdl-layout mdl-js-layout">
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            <!-- Title -->
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400" href="${pageContext.request.contextPath}/admin/manageBoard">游戏论坛</a>
                ...
                <div class="mdl-cell--4-col">
                    <div class="mdl-card mdl-shadow--2dp center card-width">
                        ...
                        <div class="mdl-card__supporting-text">
                            <form action="${pageContext.request.contextPath}/admin/addBoard" method="post" enctype="multipart/form-data">
								...
								<input type="file" name="file" id="file_more1" value="" accept="image/jpeg,image/png,image/jpg,image/gif">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            &nbsp&nbsp&nbsp
                                            <a href="${pageContext.request.contextPath}/admin/manageBoard">
